...
// Define a type for renderActiveShape props
interface RenderActiveShapeProps extends PieProps {
  cx?: number;
  cy?: number;
  innerRadius?: number;
  outerRadius?: number;
        ...
        >
          <PieChart width={220} height={220}>
            ...
            <Pie
              ...
              outerRadius={100}
              paddingAngle={2}
              activeShape={renderActiveShape as (props: unknown) => React.ReactElement} // Fixed type
              activeIndex={[0, 1, 2, 3]}
            >

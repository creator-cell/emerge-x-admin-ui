...
export default function TaskDetails() {
  ...
  return (
    <div className="container">
      ...
      <div
        className="relative mt-12 bg-white p-4 rounded-tr-[16px] mb-4 relative"
        style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)" }}
      >
        <div className="absolute top-[-30px]  bg-white rounded-t-[16px] left-0 flex">
          <Button
            className={`${
              selectedTab === "comments"
                ? "bg-white shadow-[4px_0px_6px_rgba(0,0,0,0.1)]"
                : "bg-transparent"
            } hover:bg-white-700 text-green-700 text-[16px] border-none rounded-t-[16px]`}
        ...
        <Tabs defaultValue="comments">
          <TabsContent value="comments">
            ...
            <div className="flex gap-2">
              <Button className="bg-green-600 hover:bg-white-700 text-[16px]">
                Save
              </Button>
              <Button className="bg-transparent border-none shadow-none hover:bg-white-700 text-green-700 text-[16px]">
                Cancel
              </Button>
            </div>
            ...
            <div className="mt-8 space-y-6 ">
              <div>
                <div className="flex gap-3 items-center">
                  <div className="w-8 h-8 rounded-full chatAvatarBg flex items-center justify-center text-sm font-medium text-emerald-700 profileBG">
                    G
                  </div>
                ...
                <div className="flex justify-between items-center headerBGRequest pt-2 pb-2 pl-4 pr-4 mt-4 rounded-[16px]">

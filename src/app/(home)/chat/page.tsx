...
import { AttachSquareIcon, SendIcon } from "@/assets/icons/svg-icons";
...
export default function Page() {
  ...
  return (
    ...
    <div className="flex h-screen sm:h-[90vh] sm:flex-row flex-col bg-custom-gradient gap-4 mt-4 mb-4">
